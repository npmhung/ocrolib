...
def M7_1(weights_path=None, input_shape=(1, 64, 64), n_output=None):
    ...
    model.add(Convolution2D(256, 3, 3, border_mode='same'))
    model.add(Activation('relu'))
    # model.add(Convolution2D(filters=256, kernel_size=3, strides=3,data_format='channels_first'))
    # model.add(Activation('relu'))
    model.add(MaxPooling2D(pool_size=(2, 2), dim_ordering="th"))
    model.add(Dropout(0.25))
    ...
    model.add(Convolution2D(512, 3, 3, border_mode='same'))
    model.add(Activation('relu'))
    # model.add(Convolution2D(filters=512, kernel_size=3, strides=3,data_format='channels_first'))
    # model.add(Activation('relu'))
    model.add(MaxPooling2D(pool_size=(2, 2),  dim_ordering="th"))
    model.add(Dropout(0.25))
